...
export class HomeWorkspaceComponent {
  proxPaciente: string = 'João Bobo';
  dataProxPaciente:string = '16/12/2024';
  horaProxPaciente: string = '16:00';
  email: string = 'Johnbobo@gmail.com';
  usuario: string = '';
  ultimaConsulta = []
  
  ultimasConsultas = [
    { data: '10/01/2024', hora: '15:00', paciente: 'João Bobo' },
    { data: '15/02/2024', hora: '16:00', paciente: 'João Bobo'},
    { data: '20/03/2024', hora: '11:00', paciente: 'João Bobo' },
    { data: '30/04/2024', hora: '16:00', paciente: 'João Bobo' },
  ];
